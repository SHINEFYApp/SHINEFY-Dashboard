...
export const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle, currentPath = '/bookings/create' }) => {
    ...
    useEffect(() => {
        ...
        } else if (currentPath.startsWith('/advertising')) {
            setExpandedMenu('Advertising');
        }
    }, [currentPath]);
    ...
    const allMenuItems: MenuItem[] = [
        ...
        },
        {
            ...
            isActive: currentPath?.startsWith('/advertising'),
            subItems: [
                {
                    icon: null,
                    label: 'Manage Ads',
                    i18nKey: 'sidebar.manageAds',
                    path: '/advertising/manage',
                    permissionId: PRIVILEGES.AD_SECTION,
                },
            ],
        },
        {
