    ...
    return (
        ...
        {({ values, setFieldValue, errors, touched, getFieldProps }) => {
            ...
            const handleRemoveFile = useCallback(
                (id: string) => {
                    const updated = filePreviews.filter((f) => f.id !== id);
            ...
            <Form>
                ...
                <div className="w-[35%] h-[90vh] flex flex-col bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    {/* To & Subject */}
                    <div className="h-[100px] w-full px-4 flex flex-col justify-around">
                        <ToInput
                            values={values}
                    ...
                    <div className="flex-1 p-4 flex flex-col gap-5 overflow-auto scrollbar-hide">
                        <textarea
                            className={`${currentDirBtn?.class} ${leftBtns.isBold && "font-bold"} ${leftBtns.isItalic && "italic"} ${leftBtns.isUnderline && "underline"} w-full scrollbar-hide min-h-[88%] resize-none focus:outline-none p-4`}
                        ...
                        <div className="flex flex-col items-start gap-2">
                            ...
                            {/* Preview */}
                            {filePreviews.filter((fileItem) => fileItem.file.type.startsWith("image/")).length > 0 && (
                                <div className=" w-full">
                                    <h3 className="mb-5 pb-2 border-b font-bold border-gray-100">Images</h3>
                                        <div className="flex flex-wrap items-center gap-2 flex-1">
                                            {filePreviews.map((fileItem) => {
