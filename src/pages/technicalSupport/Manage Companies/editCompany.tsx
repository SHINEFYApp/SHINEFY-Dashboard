...
import { useGetCompany, useUpdateCompany } from "../../../api/features/companies.hooks";
...
export default function EditCompany() {
    ...
    const booleanToValue = (val: boolean | null | undefined) => {
            ...
            <div className="w-full bg-white shadow-md px-4 md:px-6 py-4 rounded-2xl min-h-screen">
                {isLoading ? (
                    ...
                    <Formik
                        initialValues={{
                            name: company.name || "",
                            email_extension: company.email_extension || "",
                            code: company.code || "",
                            num_of_users: company.num_of_users?.toString() || "",
                            percentage: company.percentage?.toString() || "",
                            company_benefit_percentage: company.company_benefit_percentage?.toString() || "",
                            apply_on_services: booleanToValue(company.apply_on_services),
                            apply_on_extra_services: booleanToValue(company.apply_on_extra_services),
                            start_date: company.start_date || "",
                            end_date: company.end_date || "",
                            services_ids: company.services_ids || [],
                            extra_services_ids: company.extra_services_ids || [],
                        }}
