...
export const manageMakeColumns = [
    {
        ...
        title: "Brand Logo",
        render: (image: string) => (
            <img src={image?.startsWith("http") ? image : `${import.meta.env.VITE_IMAGES_URL}/${image}`} alt="Brand Logo" className="w-14 h-14 object-contain mx-auto" />
        )
    },
    {
        key: "make_name",
        ...
        render: (_: any, row: any) => (
            <div className="flex gap-2 items-center">
                <button
                    ...
                    onClick={() => console.log('Update', row.make_id)}
                >
                ...
                <button
                    ...
                    onClick={() => console.log('Delete', row.make_id)}
                >
                    <Trash2 /> delete
                </button>
            </div>
